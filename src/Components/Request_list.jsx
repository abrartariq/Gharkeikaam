...
class MyRequests extends Component {
  ...
  render() {
    const pending = Object.keys(this.state.adminrequestspending).map((key,i) => {
      return (
        <p className="list-group-item text-left font-weight-bold xyz" key={i}>
          Request ID:{" "}
          <div className="list-inline-item font-weight-normal">
            {this.state.adminrequestspending[key][0]}{" "}
          </div>{" "}
          <br />
          Service:{" "}
          <div className="list-inline-item font-weight-normal">
            {this.state.adminrequestspending[key][1]}{" "}
          </div>{" "}
          <br />
          Status:{" "}
          <div className="list-inline-item font-weight-normal">
            {this.state.adminrequestspending[key][2]}
          </div>{" "}
          <br />
          <button
            type="button"
    ...
    const inprogress = Object.keys(this.state.adminrequestsinprogress).map(
      key => {
        return (
          <p className="list-group-item text-left font-weight-bold xyz">
            Request ID:{" "}
            <div className="list-inline-item font-weight-normal">
              {this.state.adminrequestsinprogress[key][0]}{" "}
            </div>{" "}
            <br />
            Service:{" "}
            <div className="list-inline-item font-weight-normal">
              {this.state.adminrequestsinprogress[key][1]}{" "}
            </div>{" "}
            <br />
            Status:{" "}
            <div className="list-inline-item font-weight-normal">
              {this.state.adminrequestsinprogress[key][2]}
            </div>{" "}
            <br />
            <button
              type="button"
    ...
    const completed = Object.keys(this.state.adminrequestsincompleted).map(
      key => {
        return (
          <p className="list-group-item text-left font-weight-bold xyz">
            Request ID:{" "}
            <div className="list-inline-item font-weight-normal">
              {this.state.adminrequestsincompleted[key][0]}{" "}
            </div>{" "}
            <br />
            Service:{" "}
            <div className="list-inline-item font-weight-normal">
              {this.state.adminrequestsincompleted[key][1]}{" "}
            </div>{" "}
            <br />
            Status:{" "}
            <div className="list-inline-item font-weight-normal">
              {this.state.adminrequestsincompleted[key][2]}
            </div>{" "}
            <br />
            <button type="button" className="btn btn-primary s">
              View Request
            </button>
            <br />
          </p>
